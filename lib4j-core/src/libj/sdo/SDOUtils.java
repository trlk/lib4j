...
import libj.java.ClassUtils;
import libj.utils.Text;

public class SDOUtils {

	private static final String SDO_CLASS_NAME = "commonj.sdo.DataObject";
	private static final boolean IS_SDO_AVAILABLE = ClassUtils.tryLoad(SDO_CLASS_NAME);

	public static boolean isAvailable() {

		return IS_SDO_AVAILABLE;
	}
