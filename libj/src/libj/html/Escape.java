...
public class Escape {
	...
	/**
	 * <p>
	 * Escapes the characters in a <code>String</code> using HTML entities and writes them to a <code>Writer</code>.
	 * </p>
	 * <p>
	 * For example:
	 * </p>
	...
	static class Entities {
		...
		static class BinaryEntityMap extends ArrayEntityMap {
			...
			/**
			 * Constructs a new instance of <code>ArrayEntityMap</code> specifying the size by which the underlying
			 * array should grow.
			 * 
			 * @param growBy
			 *            array will be initialized to and will grow by this
	...
	class IntHashMap {
		 ...
		 * @return <code>true</code> if and only if some key maps to the <code>value</code> argument in this hashtable
		 *         as determined by the <tt>equals</tt> method; <code>false</code> otherwise.
		 ...
		 *         key in this hashtable, as determined by
		 ...
		 * @return the value to which the key is mapped in this hashtable; <code>null</code> if the key is not mapped to
		 ...
		 * </p>
		 * <p>
		 * The value can be retrieved by calling the <code>get</code> method with a key that is equal to the original
		 * key.
		 * </p>
		 * 
		 * @param key
		 ...
		 * @param value
		 *            the value.
		 * @return the previous value of the specified key in this hashtable, or <code>null</code> if it did not have
		 *         one.
		 * @throws NullPointerException
		 ...
		 *         or <code>null</code> if the key did not
		 *         have a mapping.
		 */
